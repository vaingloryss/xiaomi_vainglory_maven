...
<script type="text/javascript">
	function deleteAddr(id){
		...
		if(res==true){
			window.location.href="addressServlet?op=deleteAddress&id="+id;
		}
	}
	function defaultAddr(id){
		var res = confirm("是否设为默认");
		if(res==true){
			window.location.href="addressServlet?op=defaultAddress&id="+id;
    ...
    <div id="dingdanxiangqing_body_big">
     ...
     <div id="big_right" style="height: 500px;overflow: scroll;">
							...
							<div class="modal fade" tabindex="-1" role="dialog" id="myModal${address.id}">
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
									...
									<form action="addressServlet?op=updateAddress" method="post" class="form-horizontal">
		...
		<div class="container" style="width:960px;">
			...
			<form action="addressServlet?op=addAddress" method="post" class="form-horizontal">
				<div class="form-group">
