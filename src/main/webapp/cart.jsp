...
<head>
	...
	<script type="text/javascript">
		...
		function pNum(pid,p,no){
			$.ajax({
				url:"cartServlet?op=addGoods&goodsId="+pid+"&number=1",
				method:"get",
				success:function(){
					location.href = "cartServlet?op=showCart";
					location.href = "cartServlet?op=showCart";
				},
				error:function(){
					alert("服务器异常");
		...
		function mNum(pid,p,no){
			...
			$.ajax({
				url:"cartServlet?op=addGoods&goodsId="+pid+"&number="+num,
				method:"get",
				success:function(){
					location.href = "cartServlet?op=showCart";
				},
		...
		function deleteCart(pid){
			if(confirm("确认要删除吗")){
				$.ajax({
					url:"cartServlet?op=addGoods&goodsId="+pid+"&number=0",
					method:"get",
					success:function(){
						location.href = "cartServlet?op=showCart";
					},
	...
	<div class="row">
		<div class="pull-right" style="margin-right: 40px;">
			...
			<div>
				...
				&nbsp;&nbsp;
				<a href="${pageContext.request.contextPath}/orderServlet?op=getOrderView" class="btn  btn-danger btn-lg">结账</a>
